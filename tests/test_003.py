...
def test_alerts_js():
    ...
    Logger.info("Подготовка alerts js")
    ...
    text_alert = alerts.click_js_and_close_alert()
    ...
    text_confirm = alerts.click_js_and_close_confirm()
    ...
    text_promt = alerts.click_js_promt()
